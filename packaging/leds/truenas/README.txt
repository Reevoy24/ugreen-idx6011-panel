...
TrueNAS update. It uses the statically linked `ugreen_leds_cli` from
...
All colors, brightness and activity settings live in one file:
    /mnt/<your-pool>/ugreen-leds/ugreen-leds-mon.conf
...
480f114b): https://github.com/klein0r/ugreen_leds_controller
