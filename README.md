...
[![Release](https://img.shields.io/badge/release-v1.7.2-2ea44f)](../../releases/latest)
...
```bash
wget https://github.com/Reevoy24/ugreen-idx6011-panel/releases/download/v1.7.2/ug-paneld_1.7.2_amd64.deb
dpkg -i ug-paneld_1.7.2_amd64.deb
```

This installs the binary and enables and starts the service. A no-blacklist variant (`ug-paneld_1.7.2_no-blacklist_amd64.deb`) is available if you would rather manage the `i2c-hid-acpi` module yourself.
...
```bash
wget https://github.com/Reevoy24/ugreen-idx6011-panel/releases/download/v1.7.2/ug-paneld_1.7.2_truenas_amd64.tar.gz
tar xzf ug-paneld_1.7.2_truenas_amd64.tar.gz && cd ug-paneld
...
```bash
wget https://github.com/Reevoy24/ugreen-idx6011-panel/releases/download/v1.7.2/ug-paneld_1.7.2_unraid_amd64.tar.gz
tar xzf ug-paneld_1.7.2_unraid_amd64.tar.gz && cd ug-paneld
sh install.sh
```
